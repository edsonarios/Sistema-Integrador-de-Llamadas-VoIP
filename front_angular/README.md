...
- :ballot_box_with_check: Añadir Scroll en los componentes para no pasarse del rango
- :ballot_box_with_check: añadir metodo a la barra de busqueda por agenda
- :ballot_box_with_check: adicionar metodos al template - operador para configuracion de microfono, audio y red(señal)
- :ballot_box_with_check: Añadir metodos al componente audio_player
- :ballot_box_with_check: Agregar metodos al componente para realizar descargas
- :ballot_box_with_check: crear metodo donde ira el pipe de busqueda
- :ballot_box_with_check: Desplegar datos mediante servicio al template-operador
- :ballot_box_with_check: Desplegar datos mediante servicio al template-administrador
- :ballot_box_with_check: Adicionar las opciones restantes al Administrador
- :ballot_box_with_check: Adicionar Metodo para dar de Alta un contacto
- :ballot_box_with_check: adicionar modal de verificacion para contactos
- :ballot_box_with_check: Adicionar Metodo para dar de Alta una Sala
- :ballot_box_with_check: adicionar modal de verificacion para Salas
- :ballot_box_with_check: Optimizar metodos por componente
- :ballot_box_with_check: Realizacion de pruebas al operador
- :ballot_box_with_check: Realizacion de pruebas al administrador
